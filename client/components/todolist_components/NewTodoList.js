    ...
    <div className="newtodo col-md-6">
      ...
      <form onChange={this.updateNewTodoName} onSubmit={this.createTodo}>
        <div className="input-group">
          <input id="new_todo_name" type="text" className="newtodo-input form-control" value={this.state.newTodoName} placeholder="New stuff list..." aria-label="New stuff list..."/>
